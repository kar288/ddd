var colorAndResizeSampleView = function(data, participantOrder) {
  ...
  var formatData = function(d) {
    ...
    return Object.keys(switches).map(function(instrument) {
      return {
        instrument: instrument,
        length: switches[instrument],
  ...
  caseGroup.selectAll('rect')
    ...
    .attr('transform', function(d) {
      var i = instruments.indexOf(d.instrument);
