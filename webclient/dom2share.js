...
root.DOM2Share = (function() {
  function DOM2Share(doc, targetDOMElement, callback) {
    ...
    this.loadDocIntoDOM();
    callback(this.doc, this.rootElement);
  }

  DOM2Share.prototype.loadDocIntoDOM = function() {
    this.targetDOMElement.appendChild($.jqml(this.doc.getSnapshot())[0]);
    this.rootElement = $(this.targetDOMElement).children()[0];
    this.pathTree = util.createPathTree(this.rootElement, null, true);
    ...
    this.context._onOp = (function(_this) {
      return function(ops) {
        ...
        for (i = 0, len = ops.length; i < len; i++) {
          op = ops[i];
          ot2dom.applyOp(op, _this.rootElement);
        }
        util.check(_this.rootElement, _this.pathTree);
        return _this.observer.observe(_this.rootElement, {
          childList: true,
          subtree: true,
          attributes: true,
          characterData: true,
    ...
    return this.observer.observe(this.rootElement, {
      childList: true,
      subtree: true,
      attributes: true,
      characterData: true,
  ...
  DOM2Share.prototype.handleMutations = function(mutations) {
    ...
    return util.check(this.rootElement, this.pathTree);
  };
